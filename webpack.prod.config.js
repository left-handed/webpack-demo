...
const PurgecssPlugin = require('purgecss-webpack-plugin'); // Css 树摇优化代码，需要 CssMinimizerPlugin 插件配合使用
...
module.exports = {
  ...
  resolve: {
    alias: {
      'react': path.resolve(__dirname, './node_modules/react/umd/react.profiling.min.js'),
      'react-dom': path.resolve(__dirname, './node_modules/react-dom/umd/react-dom.profiling.min.js')
    },
